...
function ineExtract(obj) {
    ...
    if($(obj).attr('es_seccional') == 1 || $(obj).attr('es_coordinador') == 1  || $(obj).attr('es_promovido') == 1){
        swal("PROMOTORES",
            "Ya Pertenece a Otro Grupo",
            "warning");
    }else {
        if($('#seccional_id_'+consecutivo).val() !=='0'){
            $.ajax({
                ...
                data: {
                    ...
                    seccional_id: parseInt($('#seccional_id_' + consecutivo).val()),
