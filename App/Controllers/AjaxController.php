...
class AjaxController extends Controller  {
    ...
    public function searchPromotores()
    {
        ...
        if(strlen($_POST['search'])>4)
        {
            $allSeccionals = Ine::where('es_seccional', '=', true)->select("consecutivo","nombre_completo","clave_de_elector")->get()->toArray();
    ...
    * */
    ...
    public function mostrarXLS()
    {
        ...
        $allUsers = Ine::where('promotor_id', '=', $promotor_id)->get()->toArray();
